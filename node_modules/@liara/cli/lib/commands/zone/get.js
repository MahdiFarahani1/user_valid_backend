...
class Get extends Command {
    async run() {
        ...
        try {
            const { data } = await this.got(Get.PATH.replace('{zone}', zone)).json();
            const createdAtshamsiData = shamsi.gregorianToJalali(new Date(data.createdAt));
...
Get.description = 'inspect zone details';
Get.baseURL = 'https://dns-service.iran.liara.ir';
Get.PATH = 'api/v1/zones/{zone}';
Get.flags = {
    ...Command.flags,
    zone: Flags.string({
        char: 'z',
