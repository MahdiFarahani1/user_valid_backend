...
class BucketDelete extends Command {
    ...
    async promptBuckets() {
        ...
        try {
            ...
            this.spinner.stop();
            if (!buckets.length) {
                this.warn('Please go to https://console.liara.ir/buckets and create an bucket, first.');
                this.exit(1);
            }
...
BucketDelete.description = 'delete a bucket';
BucketDelete.flags = {
    ...Command.flags,
    bucket: Flags.string({
        char: 'b',
...
BucketDelete.aliases = ['bucket:delete'];
